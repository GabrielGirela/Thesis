...
Figure \ref{fig:integrated_vf_c}, on the other hand, shows the integrate crystal volume fraction profiles for the entire domain (\ref{fig:integrated_vf_c} a, green line), the top boundary (\ref{fig:integrated_vf_c} b, red line) and the bottom boundary (\ref{fig:integrated_vf_c} b, blue line). The total crystallinity of the system follows a positive trend, with the total amount of crystal fraction increasing with time, as the overall temperature of the system decreases. However, the crystal fraction at the boundaries behaves opposite to this: the total amount of crystals decreases with time. This is an interesting result, as it opposes the expected behavior of a cooling magmatic chamber, and will be further explained in the next chapter.
\begin{figure}
	\centering
